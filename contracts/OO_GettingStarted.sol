...
contract OO_GettingStarted {
    ...
    // it's used to ask arbitrary questions
    // per example: weather on a particular day
    ...
    // request time will be re-used later to set time that a requesting is being made
    uint256 requestTime = 0;

    // function to request data to the Optimistic oracle.
